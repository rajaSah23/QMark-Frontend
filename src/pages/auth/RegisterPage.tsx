                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                {...register('name')}
                                className={`w-full pl-10 pr-4 py-2 rounded bg-mine-shaft-800 text-white border ${errors.name ? 'border-red-500' : 'border-mine-shaft-700'
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className={`w-full pl-10 pr-10 py-2 rounded bg-mine-shaft-800 text-white border ${errors.confirmPassword ? 'border-red-500' : 'border-mine-shaft-700'
                                    } focus:outline-none focus:ring-2 focus:ring-bright-sun-500`}
                            />
                            <button
                                type="button"
