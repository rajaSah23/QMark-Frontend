  ...
  return (
    <aside className="w-64 h-full bg-mine-shaft-950 text-white p-4 overflow-y-auto">
      <div className="mb-6 border-b border-mine-shaft-800 pb-4">
        <div className="text-xs uppercase tracking-[0.18em] text-mine-shaft-400 mb-2">Question Library</div>
        <div className="flex flex-col gap-2">
          <Link to="/questions" className="flex items-center gap-2 p-2 rounded-md hover:bg-mine-shaft-800 text-bright-sun-400 font-semibold transition-colors">
            All Questions
          </Link>
          <Link to="/questions/bookmarks" className="flex items-center gap-2 p-2 rounded-md hover:bg-mine-shaft-800 text-mine-shaft-200 font-semibold transition-colors">
            Bookmarks
          </Link>
        </div>
      </div>
      ...
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-xl font-semibold">Subject Filters</h2>
        <button
          onClick={() => navigate("/profile#master-settings")}
          className="text-xs text-bright-sun-400 hover:text-bright-sun-300 transition-colors"
        >
          Manage
        </button>
      </div>
